#!/usr/bin/env python3
"""
Hent Vercel Access Token fra Google Secret Manager
...
def get_vercel_token():
    """Hent Vercel Access Token fra Secret Manager"""
    try:
        ...
        print(f"Error: Could not retrieve Vercel token from Secret Manager: {e}", file=sys.stderr)
